    ...
    <table class="table table-hover table-striped">
        ...
        <c:forEach var="album" items="${albums}">
            <tr>
                ...
                <td><a href="compositionsByAlbum?id=<c:out value='${album.getId()}'/>">View</a></td>
                <td><a href="editalbum?id=<c:out value='${album.getId()}'/>">Edit</a></td>
                <td><a href="deletealbum?id=<c:out value='${album.getId()}'/>">Delete</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
