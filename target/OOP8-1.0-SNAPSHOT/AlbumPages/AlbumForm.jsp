...
<div class = "container" style="width: 600px; margin-top: 150px;">
    <form class="row g-3"  action="updatealbum?id=${album.getAlbumId()}"  method="post">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="AlbumName" name = "AlbumName" aria-describedby="Album name" placeholder="Название альбома" required = "required" value="<c:out value='${album.getName()}'/>" onblur="lockSubmit(${album.getAlbumId()})">
        </div>
        <div class="col-md-6">
            <label for="AlbumGenre">Жанр альбома</label>
            <input type="text" class="form-control" id="AlbumGenre" name = "AlbumGenre" placeholder="Жанр альбома" required = "required" value = "<c:out value='${album.getGenre()}'/>">
        </div>
        <div class = "col-md-12">
        ...
        <div class = "col-md-12" style="margin-top: 10px; margin-bottom: 10px">
            <fieldset>
                ...
                <input list = "SingerName" name ="SingerName" class ="form-control" required = "required" id="inp" value = "<c:out value='${album.getSingerName()}'/>">
                    <script>
