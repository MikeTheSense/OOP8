...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <div class = "container">
     <div class="row">
         <div class="col-sm-8"><a href="addalbum">Create album</a></div>
     </div>
            <table class="table table-hover table-striped">
                <thead class="thead-dark">
                <tr>
                    <th scope="col-md-8">Author name</th>
                    <th scope="col-md-8">Name</th>
                    <th scope="col-md-4">Genre</th>
                    <th scope="col-md-2">Compositions</th>
            ...
            <c:forEach var="album" items="${albums}">
                <tr>
                    <td><c:out value="${album.getSingerName()}"/></td>
                    <td><c:out value="${album.getName()}"/></td>
                    <td><c:out value="${album.getGenre()}"/></td>
                    <td><a href="compositionsByAlbum?id=<c:out value='${album.getAlbumId()}'/>">View</a></td>
                    <td><a href="editalbum?id=<c:out value='${album.getAlbumId()}'/>">Edit</a></td>
                    <td><a href="deletealbum?id=<c:out value='${album.getAlbumId()}'/>">Delete</a></td>
                </tr>
            </c:forEach>
                </tbody>
            </table>
     <div class="row">
         <div class="col"><a href="allsingers">To all singers</a></div>
         <div class="col" style="align-content: flex-end">
             <div class="float-right">
                 <a href="compositions">To all compositions</a>
             </div>
         </div>
     </div>
 </div>
